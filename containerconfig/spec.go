// Package containerconfig defines a runtime-neutral container configuration.
// Adapter subpackages translate Spec to and from Compose and native runtime
// protocols without coupling consumers to adapters they do not use.
...
// Spec is the portable configuration shared by Compose and runtime adapters.
// It contains no Compose, client, transport, provenance, or mutation types.
type Spec struct {
	ServiceName       string
...
// Platform identifies one operating-system and architecture target.
