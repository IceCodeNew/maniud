...
func TestCreateMountUlimitAndHealthBranches(t *testing.T) {
	...
	invalidUlimits := [][]containerconfig.Ulimit{
		{{Name: "", Soft: 1, Hard: 2}}, {{Name: "nofile", Soft: -2, Hard: 2}},
		{{Name: "nofile", Soft: -1, Hard: 2}}, {{Name: "nofile", Soft: 3, Hard: 2}},
		{{Name: "nofile", Soft: 1, Hard: 2}, {Name: "NOFILE", Soft: 1, Hard: 2}},
	}
	...
	if values, valid := createUlimits([]containerconfig.Ulimit{{Name: "nofile", Soft: 1, Hard: -1}}); !valid || values[0].Type != "RLIMIT_NOFILE" {
