...
func openStateAnchor(ctx context.Context, path string) (*stateAnchor, error) {
	...
	anchor := &stateAnchor{
		...
		directoryID:   fileIdentity{device: 0, inode: 0, mode: 0, owner: 0},
		lockID:        fileIdentity{device: 0, inode: 0, mode: 0, owner: 0},
		databaseID:    fileIdentity{device: 0, inode: 0, mode: 0, owner: 0},
		walID:         fileIdentity{device: 0, inode: 0, mode: 0, owner: 0},
		sharedID:      fileIdentity{device: 0, inode: 0, mode: 0, owner: 0},
	}
...
func (anchor *stateAnchor) openRegular(name string) (fileIdentity, bool) {
	...
	if err != nil {
		return fileIdentity{device: 0, inode: 0, mode: 0, owner: 0}, false
	}
...
func (anchor *stateAnchor) validDirectory() bool {
	...
	return directoryValid && pathValid && directory == anchor.directoryID && path == anchor.directoryID
}
