...
// MarkActionEffectOutcomeUnknown durably closes the blind replay window before
// the caller performs the external effect. Recovery must probe before deciding
// whether the idempotent effect still needs to run.
