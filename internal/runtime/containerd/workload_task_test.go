...
func TestNativeTaskStartLifecycle(t *testing.T) {
	...
	if err := fixture.backend.Start(context.Background(), fixture.container.GetID()); err != nil ||
		created != 1 || started != 1 || fixture.host.ensureCalls != 1 || fixture.network.ensureCalls != 1 {
		t.Fatalf(
...
func TestNativeTaskStartFailureMatrix(t *testing.T) {
	...
	tests := []struct {
		...
		{name: "namespace", mutate: func(fixture nativeManagedFixture) { fixture.host.ensureErr = errContainerdTest }},
